...
@endsection
@section('page-title', __('Laporan Peminjaman & Pengembalian'))
@section('page-heading', __('Laporan Peminjaman & Pengembalian'))
    ...
    <div class="modal fade" id="modalReport" tabindex="-1" role="dialog"
        ...
        role="document">
            <div class="modal-content">
                ...
                {{ Form::open(array('url' => 'laporan/pinjam-kembali/report-pdf', 'method' => 'post', 'id' => 'formExport' )) }}
