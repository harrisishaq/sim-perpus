...
@endsection
@section('page-title', __('Laporan Denda'))
@section('page-heading', __('Laporan Denda'))
                        ...
                        @if (count($data))
                            @foreach ($data as $d)
                                <tr>
                                    ...
                                    <td style="text-align:center">{{ $d->transaksiInformation->date_from }}</td>
                                    <td style="text-align:center">{{ $d->transaksiInformation->date_returned }}</td>
                                    <td style="text-align:center">{{ $d->hari_telat }}</td>
                                    <td style="text-align:center">{{ $d->denda }}</td>
                                    {!! Azk::getDataDenda ($d->status) !!}
                                </tr>
                            @endforeach
                        @else
                            <tr>
    ...
    <div class="modal fade" id="modalReport" tabindex="-1" role="dialog"
        ...
        role="document">
            <div class="modal-content">
                ...
                {{ Form::open(array('url' => 'laporan/denda/report-pdf', 'method' => 'post', 'id' => 'formExport' )) }}
