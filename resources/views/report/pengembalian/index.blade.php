...
@endsection
@section('page-title', __('Laporan Pengembalian'))
@section('page-heading', __('Laporan Pengembalian'))
    ...
    <div class="modal fade" id="modalReport" tabindex="-1" role="dialog"
        ...
        role="document">
            <div class="modal-content">
                ...
                {{ Form::open(array('url' => 'laporan/pengembalian/report-pdf', 'method' => 'post', 'id' => 'formExport' )) }}
